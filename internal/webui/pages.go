...
const style = `<style>
:root{--fg:#181b1a;--dim:#717674;--faint:#9ba09e;--line:#e2e6e3;--line2:#ccd2ce;--ok:#239b68;--oksoft:#eef8f3;--bad:#b84c4c;--badsoft:#fff3f2;--warn:#a66a14;--warnsoft:#fff8eb;--info:#477d9c;--route:#239b68;--bg:#fcfcfb;--card:#fff;--card2:#f7f8f7;--ink:#181b1a;--font-mono:"Cascadia Mono","SFMono-Regular","Roboto Mono","DejaVu Sans Mono",Consolas,"Liberation Mono",ui-monospace,monospace}
...
a{color:inherit;text-decoration:none;transition:color .14s ease}a:hover{color:var(--ok)}code,.mono{font-family:var(--font-mono);font-variant-ligatures:none;font-feature-settings:"zero" 1}
...
@keyframes loom-page-in{from{opacity:.82;transform:translateY(3px)}to{opacity:1;transform:none}}
...
.topology{width:100%;min-height:330px;display:block;background:transparent}.topology .tunnel{stroke:#a5aaa8;stroke-width:1.25;opacity:.95}.topology .candidate{stroke:#b9bebc;stroke-width:1.35;stroke-dasharray:5 6;opacity:.9}.topology .degraded{stroke:#d79b3b}.topology .failed{stroke:#c65a5a}.topology .unknown{stroke:#a5aaa8;stroke-dasharray:3 7;opacity:.7}.topology .route{stroke:var(--route);stroke-width:2;opacity:.95}.topology .node{fill:var(--ok);stroke:#fff;stroke-width:3}.topology .node.problem{fill:var(--bad)}.topology .node.unknown{fill:#a5aaa8;stroke:#fff;stroke-dasharray:none}.topology .node.undeclared{fill:var(--warn);stroke:#fff}.topology .node.selected{fill:var(--ok);stroke:#fff;stroke-width:3}.topology text{fill:var(--fg);font:650 13px var(--font-mono)}.topology .sub{fill:var(--dim);font:400 11px/1.4 Inter,ui-sans-serif,system-ui}
