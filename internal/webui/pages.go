...
.clients-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));overflow:hidden;margin-bottom:14px;padding:0}.clients-summary-item{padding:14px 18px;border-right:1px solid var(--line)}.clients-summary-item:last-child{border-right:0}.clients-summary-item .metric{font-size:21px}.clients-layout{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(310px,.7fr);align-items:start;gap:14px}.clients-list-card{padding:0;overflow:hidden}.clients-card-head{display:flex;align-items:center;gap:12px;padding:14px 16px;border-bottom:1px solid var(--line)}.clients-card-head h2{margin:0;color:var(--fg);font-size:15px;letter-spacing:-.01em;text-transform:none}.clients-card-head p{margin:1px 0 0;font-size:10px}.clients-table{min-width:720px}.clients-table th:first-child,.clients-table td:first-child{padding-left:16px}.clients-table th:last-child,.clients-table td:last-child{padding-right:16px}.client-name{display:grid;gap:0}.client-name b{font-size:12px}.client-name span{font-size:10px}.client-status{display:inline-flex;align-items:center;gap:6px}.client-status .dot{width:6px;height:6px}.client-platform{display:inline-flex;align-items:center;min-width:65px}.client-empty{padding:34px 18px;text-align:center}.client-empty b{display:block;margin-bottom:3px}.linux-delivery{display:grid;gap:12px}.linux-package{display:grid;gap:12px}.linux-package-head{display:flex;align-items:flex-start;gap:12px}.linux-package-head h2{margin:0 0 3px;color:var(--fg);font-size:15px;letter-spacing:-.01em;text-transform:none}.linux-package-meta{display:grid;grid-template-columns:auto minmax(0,1fr);gap:5px 12px;padding-top:10px;border-top:1px solid var(--line);font-size:10px}.linux-package-meta dt{color:var(--dim);text-transform:uppercase}.linux-package-meta dd{min-width:0;margin:0;overflow-wrap:anywhere}.linux-install summary{cursor:pointer;list-style:none;font-weight:650}.linux-install summary::-webkit-details-marker{display:none}.linux-install summary:after{content:"＋";float:right;color:var(--dim)}.linux-install[open] summary:after{content:"−"}.linux-install ol{margin:12px 0 0;padding-left:18px}.linux-install li{margin:9px 0}.command-block{display:block;margin-top:5px;padding:8px 10px;overflow-x:auto;border:1px solid var(--line);border-radius:5px;background:var(--card2);font-size:10px;line-height:1.55;white-space:pre}.client-add-grid,.client-invite-grid{display:grid;grid-template-columns:minmax(320px,.8fr) minmax(0,1.2fr);align-items:start;gap:14px}.client-form-card h2,.client-invite-copy h2{color:var(--fg);font-size:15px;letter-spacing:-.01em;text-transform:none}.client-form-card p{margin:0 0 15px}.client-form-actions{display:flex;align-items:center;gap:8px;margin-top:18px}.client-boundary{display:grid;gap:0}.client-boundary>div{display:grid;grid-template-columns:105px minmax(0,1fr);gap:12px;padding:10px 0;border-bottom:1px solid var(--line);font-size:11px}.client-boundary>div:last-child{border-bottom:0}.client-boundary span{color:var(--dim)}.client-invite-qr{display:grid;justify-items:center;gap:11px;text-align:center}.client-invite-qr img{display:block;width:min(100%,250px);aspect-ratio:1;padding:10px;border:1px solid var(--line);border-radius:8px;background:#fff}.client-invite-qr p{max-width:300px;margin:0}.client-invite-copy{display:grid;gap:14px}.invite-link{display:flex;align-items:stretch;gap:8px}.invite-link input{min-width:0;font:11px var(--font-mono)}.invite-link .button{display:flex;align-items:center;white-space:nowrap}.client-invite-expiry{display:flex;align-items:flex-start;gap:9px;padding:10px;border-radius:6px;background:var(--warnsoft);color:var(--warn);font-size:11px}.client-invite-expiry .dot{margin-top:5px}.client-invite-actions{display:flex;flex-wrap:wrap;gap:8px}.client-result-note{margin-top:14px}
