...
.topology .route-local-exit{pointer-events:none;transition:opacity .16s ease}.topology .route-local-exit rect{stroke-width:1}.topology .route-local-exit text{fill:var(--route);stroke:none;font-family:Inter,ui-sans-serif,system-ui;font-size:8.5px;font-weight:700;letter-spacing:.045em}.topology.has-focus .route-local-exit{opacity:.12}
