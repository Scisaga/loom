...
cp -a "$repo_dir/internal/attest" "$repo_dir/internal/clientmigration" "$repo_dir/internal/clientroute" \
    "$repo_dir/internal/enrollmentv2" "$repo_dir/internal/devicehttp" "$repo_dir/internal/model" "$repo_dir/internal/observation" "$repo_dir/internal/version" \
